...
namespace Kwill.Automation.Domain.UserCases.Dashboard
{
    ...
    {
        string  articleTitle;
        public bool AccessArticlePage(IWebDriver driver, string Environment)
        {
            ...
            Assert.AreEqual(driver.Url, "http://" + Environment + "kwil.co.uk/Blog/Index", "Acces to incorrect page");
